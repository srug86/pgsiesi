...
\imagen{resumenproyectofin}{13}{Resumen del proyecto a partir de una fecha de
  fin}{ProyFe}
...
\imagen{resumenproyectolinbase}{13}{Resumen del proyecto a partir de la 
línea base}{ResPL}
...
\imagen{resumenproyectoactualizado}{13}{Resumen del plan de proyecto 
actualizado}{ResPA}
...
\imagen{Resumen}{13}{Resumen del Plan del Proyecto}{Res}
...
\begin{sidewaystable}
\imagen{gant1}{20}{Primera parte del diagrama de Gantt}{ga1}
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gant2}{20}{Segunda parte del diagrama de Gantt}{ga2}
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gant3}{20}{Tercera parte del diagrama de Gantt}{ga3}
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gant4}{20}{Cuarta parte del diagrama de Gantt}{ga4}
\end{sidewaystable}
...
\begin{sidewaystable}
\imagen{caminocritico1}{20}{Primera parte del camino crítico}{CC1}
\end{sidewaystable}

\begin{sidewaystable}
\imagen{caminocritico2}{20}{Segunda parte del camino crítico}{CC2}
\end{sidewaystable}

\begin{sidewaystable}
\imagen{caminocritico3}{20}{Tercera parte del camino crítico}{CC3}
\end{sidewaystable}

\begin{sidewaystable}
\imagen{caminocritico4}{20}{Cuarta parte del camino crítico}{CC4}
\end{sidewaystable}
...
\begin{sidewaystable}
\imagen{Recursos}{20}{Informe general de recursos del sistema}{Rec}
\end{sidewaystable}
...
\begin{sidewaystable}
\imagen{costeactividades}{20}{Informe de los costes de las
  actividades}{Cos_Ac}
\end{sidewaystable}
...
\begin{sidewaystable}
\imagen{gantredistribuido1}{20}{Primera parte del informe de
  redistribución}{Gan_re1} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantredistribuido2}{20}{Segunda parte del informe de
  redistribución}{Gan_re2} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantredistribuido3}{20}{Tercera parte del informe de
  redistribución}{Gan_re3} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantredistribuido4}{20}{Cuarta parte del informe de
...
\begin{sidewaystable}
\imagen{gantseguimiento1}{20}{Primera parte del informe de
  seguimiento}{Gan_se1} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantseguimiento2}{20}{Segunda parte del informe de
  seguimiento}{Gan_se2} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantseguimiento3}{20}{Tercera parte del informe de
  seguimiento}{Gan_se3} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantseguimiento4}{20}{Cuarta parte del informe de
  seguimiento}{Gan_se4} 
\end{sidewaystable}
\newpage
\begin{sidewaystable}
\imagen{gantseguimiento5}{20}{Quinta parte del informe de
  seguimiento}{Gan_se5} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantseguimiento6}{20}{Sexta parte del informe de
  seguimiento}{Gan_se6} 
\end{sidewaystable}

\begin{sidewaystable}
\imagen{gantseguimiento7}{20}{Séptima parte del informe de
  seguimiento}{Gan_se7} 
\end{sidewaystable}
