...
\begin{itemize}
\item Si la exposición a riesgos es mayor de horas, el riesgo se considera de
importancia alta.
\item Si la exposición a riesgos es menor de y mayor de , el riesgo se
considera de importancia media.
\item Si la exposición a riesgos es menor de , el riesgo
se considera de importancia baja.
\end{itemize}
