...
% Silabación extra
\input{/home/swarf/hyphenations.tex}
...
\imagen{PSI2-2_organosUMA.pdf}{9}{Órganos de la UMA}{Org_Uma}
...
muestra en la tabla \ref{Tab:ObjPro}. En la 
...
\subsection{Identifiación de sistemas de información actuales afectados por
  el PSI} \label{ss:5.1.2}
Todos los objetivos del PSI afectan únicamente al campus virtual, ya que la
herramienta software que se va a desarrollar estará ingrada dentro de este.
...
\item campusvirtual.uma.es es un lugar de encuentro de la comunidad
  ...
  herramienta de teleformación Campus Virtual, un entorno de virtual de
...
\begin{itemize}
  \item La web aunque desde el punto de la vista del usuario cumple con
    suficiencia su cometido ,también es cierto que se aprecian ciertas
    carencias en su contenido y sobre todo en su organización. No se ve
    necesaria ningún tipo de reforma a corto plazo. 
  \item El campus virtual cumple con eficiencia sus funciones, además de
    ...
    más o menos "nuevo", está actualizado a las necesidades actuales del
...
\subsubsection{Implamantación de los planes de estudios de cada carrera}
\begin{itemize}
...
El grupo de personas que trabajará en el proyecto estará constituido por la
...
(\ref{tab:cal}), en el que se muestran los diferentes plazos de los 
...
\centering
  \begin{tabular}{lll}
    ...
    \textbf{Acciones Asociadas} \\ \hline 
    \hline \hline
