...
\item{Descripción} Obtención detallada de información mediante sesiones de
trabajo con alumnos y profesores de la UMA, para un posterior análisis y
refinamiento de lo obtenido .
\item{Duración estimada} 
\end{itemize}
\item{Número} 1.2.2
\begin{itemize}
\item{Nombre} Validación de requisitos.
\item{Descripción}Se ponen en común los requisitos obtenidos en la fase
anterior, con las características de el sistema, se presentan a la Jefa de
proyecto (Dña. Adelaida de la Calle, rectora de la UMA), y se espera su 
aprobación.
\item{Duración estimada} 
\end{itemize}
\item{Número} 1.3.1
...
\item{Descripción} Descomposición del sistema es subsistemas.
\item{Duración estimada} 
\end{itemize}
\item{Número} 1.3.2
\begin{itemize}
