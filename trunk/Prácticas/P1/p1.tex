...
Las delimitaciones introducidas en el proyecto son:
\begin{description}
\item[Tarea 2.3.3] Revisión de la interfaz de usuario.\\
  No se debe finalizar antes del 20 de Julio de 2010. Esta condición es
  \textbf{inflexible} y no produce efectos.
\item[Tarea 2.4.3] Especificación de la distribución de datos.\\
  Deberá finalizar lo más tarde posible. Esta condición es \textbf{flexible}.
  Los efectos de esta delimitación no se puede resolver la sobreasignación
  del recurso \emph{miembro del grupo de trabajo} el 27 de Julio de 2010.
\end{description}
