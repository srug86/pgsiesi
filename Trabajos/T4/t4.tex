...
cualquiera de sus etapas afectará en cascada a las siguientes etapas.
\subsection{Causas}
...
\subsection{Descripción}
Este riesgo consiste en que el cliente, la empresa en nuestro caso, al que le 
realizamos el software solicita nuevos requisitos para incluir en el proyecto 
una vez que se validaron. La toma de requisitos normalmente se realiza en la 
etapa de análisis, pero este riesgo implica que en cualquier otra etapa 
posterior del proyecto la empresa añade más condiciones al proyecto, lo que 
...
si ocurre en la etapa de Pruebas, el impacto será mucho mayor porque se tiene 
que rehacer el proyecto. En la etapa de Análisis el impacto será menor. Se 
tiene en cuenta si los requisitos que quiere añadir la empresa contradicen 
alguno de los que ya se tienen.
...
\item El cliente no acabe satisfecho con la calidad del producto final entregado.
\end{itemize}

\subsection{Responsabilidades asignadas}
Este riesgo puede ser debido tanto a que la empresa no terminó de saber bien
los requisitos que querían en un principio o debido a una mala labor de
consulta de requisitos por parte de los analistas; por tanto, la
responsabilidad recaerá en el grupo de analistas y el jefe de proyecto, los
cuáles no supieron conseguir correctamente los requisitos de la herramienta
que el cliente quería.

\subsection{Resultados del análisis del riesgo}
Después de haber aplicado la técnica Delphi, la probabilidad de ocurrencia es
del 48\%, la magnitud de pérdida o impacto son 11.6 días, y por tanto, la
exposición al riesgo es de 5.56 días.
...
\begin{itemize}
\item Hacer una recogida de requisitas más exhaustiva añadiendo los nuevos 
requisitos.
...
presupuesto para realizar una adecuada respuesta al riesgo varía. Así, si los 
...
requisito afecta a un parte concreta del proyecto, sólo tendríamos que 
