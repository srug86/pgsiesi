...
utiliza el método de ``Puntos Función'' de \emph{Albrecht}. En cada módulo
del sistema software se identificar entradas externas, salidas externas,
consultas externas, archivos lógicos internos y archivos lógicos de interfaz
externos. 
